...
public class EgresoRepositoryImpl implements EgresoRepository{
    private final Connection connection;

    public EgresoRepositoryImpl(Connection connection) {
        this.connection = connection;
    }

    @Override
    public List<FacturaEntity> listarEgresos(FacturaEntity facturaEntity) throws Exception {
    ...
    @Override
    public List<FacturaEntity> listarEgresosFiltro(int clienteId, FacturaEntity facturaEntity, String filtro) throws Exception {
        ...
        String query = "SELECT fac.factura_id, fac.folio_factura, fac.fecha_factura, fac.fecha_cobranza, fac.rfc_emisor, " +
                ...
                "AND MONTH(fecha_cobranza) = ? AND YEAR(fecha_cobranza) = ? AND fac.tipo_factura_id = 2";
