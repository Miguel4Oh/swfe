...
@WebServlet("/egresos/filtro")
public class EgresoListarFiltroServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (httpSession.getAttribute("clienteId") != null) {
            try {
                ...
                List<FacturaEntity> facturas = egresoService.obtenerListaEgresosFiltro(
