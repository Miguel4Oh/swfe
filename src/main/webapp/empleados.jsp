        ...
        <div class="tabla-envoltura">
            <div class="tabla-header">
                ...
                <div class="botones-facturacion">
                    <a href="${pageContext.request.contextPath}/empleados/empleado-form">
                    ...
                    <table class="tabla tabla-factura">
                        ...
                        <tbody class="tabla tabla-factura cuerpo-tabla">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/empleados/empleado-form?empleado-id=<%=empleado.getEmpleadoId()%>">
                                    ...
                                    <a href="${pageContext.request.contextPath}/empleados/eliminar?empleado-id=<%=empleado.getEmpleadoId()%>">
...
<script src="${pageContext.request.contextPath}/js/filtro-consultas/consulta-empleados.js"></script>
</body>
</html>
