        ...
        <div class="tabla-envoltura">
            <div class="tabla-header">
                ...
                <div class="botones-facturacion">
                    <a class="enlace" href="${pageContext.request.contextPath}/clientes/cliente-form">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="enlace-contents"
                                   href="${pageContext.request.contextPath}/clientes/cliente-form?cliente-id=<%=cliente.getClienteId()%>">
                                ...
                                <a class="enlace-contents"
                                   href="${pageContext.request.contextPath}/clientes/eliminar?cliente-id=<%=cliente.getClienteId()%>">
...
<script src="${pageContext.request.contextPath}/js/filtro-consultas/consulta-clientes.js"></script>
