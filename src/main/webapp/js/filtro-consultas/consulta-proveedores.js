...
consultaInput.addEventListener('keyup', function () {
    ...
    const url = `/swfe/proveedores/filtro?filtro=${encodeURIComponent(filtro)}`;
...
function llenarCampos(proveedores) {
...
function llenarTabla(proveedores) {
    ...
    proveedores.forEach(proveedor => {
        console.log(proveedor.clienteId);
        ...
        tr.innerHTML = `
                ...
                <td>
                     <a class="enlace-contents"
                        href="/swfe/proveedores/proveedor-form?proveedor-id=${proveedor.proveedorId}">
                     ...
                     <a class="enlace-contents" href="/swfe/proveedores/eliminar?proveedor-id=${proveedor.proveedorId}">
