...
consultaInput.addEventListener("keyup", function () {
    ...
    const url = `/swfe/ingresos/filtro?filtro=${encodeURIComponent(filtro)}`;
...
function llenarTabla(ingresos) {
    ...
    ingresos.forEach(ingreso => {
        ...
        if (ingreso.fechaCobranza !== undefined && ingreso.fechaCobranza !== null) {
            fechaCobranza = formatearFecha(ingreso.fechaCobranza);
        } else {
