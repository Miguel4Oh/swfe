...
consultaInput.addEventListener('keyup', function () {
    ...
    const url = `/swfe/empleados/filtro?filtro=${encodeURIComponent(filtro)}`;
...
function llenarCampos(empleados) {
            ...
            tr.innerHTML = `
                ...
                <td>
                     <a class="enlace-contents"
                        href="/swfe/empleados/empleado-form?empleado-id=${empleado.empleadoId}">
                     ...
                     <a class="enlace-contents" href="/swfe/empleados/eliminar?empleado-id=${empleado.empleadoId}">
