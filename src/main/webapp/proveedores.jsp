...
<%
    List<ProveedorEntity> proveedores = (List<ProveedorEntity>) request.getAttribute("proveedores");
%>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <div class="tabla-envoltura">
            <div class="tabla-header">
                ...
                <div class="botones-facturacion">
                    <a href="${pageContext.request.contextPath}/proveedores/proveedor-form">
                ...
                <div class="tabla-contenedor">
                    <table class="tabla tabla-factura">
                        ...
                        <tbody class="tabla tabla-factura cuerpo-tabla">
                            ...
                            <tr>
                                <td><%=proveedor.getRfcProveedor()%>
                                </td>
                                <td><%=proveedor.getNombreProveedor()%>
                                </td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/proveedores/proveedor-form?proveedor-id=<%=proveedor.getProveedorId()%>">
                                    ...
                                    <a href="${pageContext.request.contextPath}/proveedores/eliminar?proveedor-id=<%=proveedor.getProveedorId()%>">
...
<script src="${pageContext.request.contextPath}/js/filtro-consultas/consulta-proveedores.js"></script>
</body>
</html>