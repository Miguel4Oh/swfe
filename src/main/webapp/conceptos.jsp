...
<html lang="es">
<head>
    <title>Conceptos depreciación</title>
    <meta charset="UTF-8">
        ...
        <div class="tabla-envoltura">
            <div class="tabla-header">
                <div class="titulo-buscador">
                    <h1>Conceptos<br>depreciación</h1>
                    <div class="buscador-contenedor">
                        ...
                        <svg width="30px" height="30px" viewBox="0 -0.5 25 25" fill="none"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  ...
                                  stroke="#000000c4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M17.029 16.5295L19.5 19.0005" stroke="#000000c4" stroke-width="1.5"
                                  stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                </div>
                <div class="botones-facturacion">
                    <a href="${pageContext.request.contextPath}/conceptos/concepto-form">
                ...
                <div class="tabla-contenedor">
                    <table class="tabla tabla-factura">
                        ...
                        <tbody class="tabla tabla-factura cuerpo-tabla">
                            ...
                            <tr>
                                <td><%=concepto.getNombreDepreciacion()%>
                                </td>
                                <td><%=concepto.getPorcentajeDepreciacion()%>%</td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/conceptos/concepto-form?concepto-id=<%=concepto.getConceptoDepreciacionId()%>">
                                    ...
                                    <a href="${pageContext.request.contextPath}/conceptos/eliminar?concepto-id=<%=concepto.getConceptoDepreciacionId()%>">
...
<script src="${pageContext.request.contextPath}/js/filtro-consultas/consulta-conceptos.js"></script>
